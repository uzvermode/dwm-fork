...
static const char colors[NUMCOLORS][ColLast][9] = {
  ...
  { "#282a2e", "#373b41", "#282a2e" }, /* 1 = normal (grey on darkgrey) */
  { "#1793D1", "#c5c8c6", "#282a2e" }, /* 2 = selected (arch blue on darkgrey) */
  { "#dc322f", "#1d1f21", "#282a2e" }, /* 3 = urgent (darkgrey on yellow) */
  { "#282a2e", "#282a2e", "#282a2e" }, /* 4 = darkgrey on darkgrey (for glyphs) */
  { "#282a2e", "#1d1f21", "#282a2e" }, /* 5 = darkgrey on darkgrey (for glyphs) */
  { "#282a2e", "#cc6666", "#282a2e" }, /* 6 = red on darkgrey */
  { "#282a2e", "#b5bd68", "#282a2e" }, /* 7 = green on darkgrey */
  { "#282a2e", "#de935f", "#282a2e" }, /* 8 = orange on darkgrey */
...
static Key keys[] = {
    ...
    { MODKEY|ShiftMask,             XK_Return,                    spawn,          {.v = sakura } },
